...
const Leaderboard = () => {
  return (
    <Container style={{ background: 'linear-gradient(to bottom, #4e54c8, #8f94fb)', minHeight: '100vh', padding: '20px 0' }}>
      <Typography variant="h3" align="center" gutterBottom style={{ color: '#fff', marginBottom: '20px' }}>
