      ...
      {selectedRow && (
        <Card style={{ marginTop: '20px', padding: '20px' }}>
          ...
          <Typography variant="body1">
            Calmar Ratio: {selectedRow["Calmar Ratio"]}
          </Typography>
          <Typography variant="body1">
            Overall Profit: {selectedRow["Overall Profit"]}
          </Typography>
          <Typography variant="body1">
            Avg. Daily Profit: {selectedRow["Avg. Daily Profit"]}
          </Typography>
          <Typography variant="body1">
            Win % (Day): {selectedRow["Win %(Day)"]}
          </Typography>
          <Typography variant="body1">
            Price (Rs): {selectedRow["Price (Rs)"] ? selectedRow["Price (Rs)"] : '-'}
          </Typography>
        </Card>
      )}
    </Container>
